...
## 機能変更15
- [x] 「これまでの日記」セクションを最新10件のみ表示するように変更

## 機能追加16
- [x] iPhoneホーム画面用アイコンを設定
- [x] PWAマニフェストファイルを作成
- [x] HTMLメタタグでapple-touch-iconを設定

## バグ修正17
- [x] Notionへの保存時のタイムゾーン処理を修正
- [x] タイトルの日付とNotionの日付フィールドが一致するように修正
- [x] 例: 「日記 2026/1/26」のタイトルが「2026年1月27日」の日付フィールドになっている問題

## データ修正18
- [x] 既存の日記データの日付フィールドをタイトルから抽出した日付で更新
- [x] タイトル「日記 2026/1/26」→ Notionの日付フィールド「2026-01-26」に修正

## 機能改奡19
- [x] マージ機能で日記を日時の古い順に連結するように修正
- [x] 同じ日に複数の日記がある場合、作成日時でソートしてから結合

## バグ修正20
- [x] マージ機能で日記が新しい順に表示される問題を修正
- [x] 古い順に結合されるようにソート順序を確認・修正
